...
- [ ] Playback as list
- [ ] Persist skip selections
- [ ] allow edit of own material
- [ ] remove cover warnings - people can deal with it themselves. VOD can honor take-down requests.

- [ ] advance row - export via reportBack pass-in
...
- once we have it working like that again
  - [ ] get the skips per user. 
  - [ ] include a temporary clean if we have the object embedded
  - [ ] set skips per user again
